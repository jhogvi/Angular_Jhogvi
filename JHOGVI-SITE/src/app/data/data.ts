...
export const eventos:Evento[]=[
	{
		...
		descricao: 'Evento de inauguração Jhogvi. Disponível para primeiras compras',
		detalhes: ['Fique atento para mais informações.'],
		...
		descricao: 'Evento com entrada limitada à compra do Boné Jhogvi (Exclusivo).',
		categoria: 'Evento',
		subcategoria: 'Inauguração',
		imagens: ['assets/img/eventos/img-evento.png'],
		detalhes: [],
